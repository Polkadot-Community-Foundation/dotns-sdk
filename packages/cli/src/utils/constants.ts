...
// Upstream's dotliViewUrls takes a bare label and dropped this import; this fork
// keeps normalising, so a caller passing a fully-qualified name still gets a
// correct URL instead of a duplicated TLD. validation.ts imports nothing from
